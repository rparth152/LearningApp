<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="ELearningPlatform.Register" %>
...
<head runat="server">
    ...
    <title>EduStream - Register</title>
    ...
    <form id="form1" runat="server">
        <div class="card-wrapper">
            ...
            <div class="card">
                ...
                <div class="card-sub">Join EduStream and start learning today!</div>
                ...
                <div class="form-group">
                    ...
                    <asp:TextBox ID="txtPassword" runat="server" placeholder="Create a password" TextMode="Password" />
                </div>

                <!-- Field Dropdown - filled from database via sp_GetAllFields -->
                <div class="form-group">
                    <label>Field</label>
                ...
                <!-- Message Label - shows error if something goes wrong -->
